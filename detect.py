...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='./runs/exp10/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--save-dir', type=str, default='img_output', help='directory to save results')
