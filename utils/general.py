...
def compute_loss(p, targets, model):  # predictions, targets, model
    ...
    return loss * bs, torch.cat((lbox, lobj, lcls, loss)).detach(), ious
...
def output_to_target(output, width, height):
    ...
    torch.cuda.synchronize()  # Make sure the CUDA stream is idle before moving to CPU
